...
public class Base_Class {
	...
	public static void iframe(int value) {
	...
	public static void clearAndInput(WebElement element, String value) {
		/*
		 * if (type.equalsIgnoreCase("string")) { element.clear();
		 * element.sendKeys(value); }else if (type.equalsIgnoreCase("int")) { int
		 * parseInt = Integer.parseInt(value); element.clear();
		 * element.sendKeys(parseInt);}
		 */
		element.clear();
